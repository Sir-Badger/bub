...
## The word processing algorythm
In order to determine how many words of roleplay a message contains, Bub uses a custom algorythm. In order to describe it, let's divide it into steps we need to accomplish:
